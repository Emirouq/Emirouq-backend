...
<head>
  ...
  <style>
    ...
    .text-zinc-400 {
      color: #5a667b;
      font-weight: 300;
      font-size: 16px; /* Corrected: removed quotes */
    }
    ...
    .border-blue-200 { /* In your original, this was light blue. Kept it for consistency, but you might want a neutral border */
      border-color: #ebf8ff;
    }
    ...
    .text-xl { /* Main heading for message */
      font-size: 17px;
      line-height: 1.5;
      font-weight: 500;
    }

    .text-lg { /* Sub-heading or salutation */
      font-size: 18px;
      line-height: 1.5;
    }
    ...
    .bold {
      font-weight: 500; /* Made it slightly bolder than original's 200 for emphasis */
      color: #454f60;
    }

    .reason-box {
      background-color: #fff9f2; /* A light yellow/orange tint for emphasis */
...
<body style="margin: 0; padding: 10px; background-color: #f0f4f8">
  <table class="bg-zinc-50" role="presentation" width="100%" cellspacing="0" cellpadding="0">
    <tr>
      <td>
        <table class="max-w-lg bg-white shadow-md rounded-lg border border-blue-200" role="presentation" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="p-6">
              <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td>
                    <div style="width: 120px">
                      <div class="img"></div> <!-- Emirouq Logo -->
                    </div>
                  </td>
                </tr>
                <tr style="height: 2rem;">
                  <td class="text-zinc-700 font-semibold" style="font-size: 18px; padding-top: 16px;">Hi ${name},</td>
                </tr>
                <tr style="height: 1.5rem;">
                  <td class="text-zinc-700 mb-4 text-xl">We're writing to inform you about a recent review of your post on Emirouq.</td>
                </tr>
                
                <tr>
                  <td class="text-zinc-400 mb-4" style="font-size: 16px; line-height: 24px; padding-top: 8px;">
                    Unfortunately, your post titled "<strong class="bold">${postTitle}</strong>" did not meet our community guidelines and has been rejected.
                  </td>
                </tr>

                <!-- Post Snippet (Optional but helpful) -->
                <tr>
                  <td style="padding-top: 8px; padding-bottom: 8px;">
                    <div class="post-details">
                        <p><strong>Post Snippet:</strong></p>
                        <p style="font-style: italic;">"${postContentSnippet}..."</p>
                    </div>
                  </td>
                </tr>

                <tr>
                  <td class="text-zinc-400" style="font-size: 16px; line-height: 24px; padding-bottom: 4px;">
                    <strong class="bold">Reason for Rejection:</strong>
                  </td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  <td class="text-sm mb-4" style="line-height: 1.6;">
                    We encourage you to review our <a href="${guidelinesLink}" target="_blank">Community Guidelines</a> to understand our posting standards better. 
                    <!-- Optional: Add link to edit and resubmit -->
                    <!-- If you'd like to revise and resubmit your post, you can do so here: <a href="${postEditLink}" target="_blank">Edit Your Post</a>. -->
                  </td>
                </tr>
                <tr style="height: 1rem;"><td></td></tr> <!-- Spacer -->
                <tr>
                  <td class="text-sm" style="line-height: 1.6;">
                    If you believe this was a mistake or have any questions, please don't hesitate to <a href="${supportLink}" target="_blank">contact our support team</a>.
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td class="p-6 bg-white border-t border-blue-200">
              <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="footer">
                    <p class="font-size" style="margin-bottom: 1rem;">Thanks,<br />The Emirouq Team</p>
                    <p style="margin-bottom: 0; font-size: 12px;">© ${new Date().getFullYear()} Emirouq. All rights reserved.</p> <!-- Dynamic year -->
                  </td>
                </tr>
              </table>
            </td>
          </tr>
          <!-- Footer with small logo and social icons - kept from your original template -->
          <tr>
            <td>
              <table class="bg-white rounded-lg" role="presentation" width="100%" style="max-width: 600px; margin: 0 auto;" cellspacing="0" cellpadding="0"> <!-- Ensured this table also respects max-width -->
                <tr>
                  <td style="padding: 10px 20px 20px 20px;"> <!-- Adjusted padding -->
                    <table width="100%" cellspacing="0" cellpadding="0">
                      <tr>
