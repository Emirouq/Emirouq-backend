    ...
    <tr>
      <td>
        <table class="max-w-lg bg-white shadow-md rounded-lg border border-blue-200" role="presentation" width="100%" cellspacing="0" cellpadding="0">
            ...
            <td class="p-6">
              <table width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr style="height: 2rem;">
                  <td class="text-zinc-700 font-semibold" style="font-size: 18px; padding-top: 16px;">Hi Admin,</td>
                </tr>
                <tr style="height: 1.5rem;">
                  <td class="text-zinc-700 mb-4 text-xl">A new support ticket has been submitted on Emirouq.</td>
                </tr>
                
                <tr>
                  <td class="text-zinc-400 mb-4" style="font-size: 16px; line-height: 24px; padding-top: 8px;">
                    Here are the details of the new support request:
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding-top: 8px; padding-bottom: 8px;">
                    <div class="ticket-details-box">
                        ...
                        <p><strong>Ticket Title:</strong> <span class="bold">${ticketTitle}</span></p>
                        <p><strong>Description:</strong></p>
                        <p style="font-style: italic;">${ticketDescription}</p>
                        <p><strong>Time Submitted:</strong> ${timestamp}</p>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="text-align: center; padding-top: 20px; padding-bottom: 20px;">
                    <a href="${supportDashboardLink}" class="btn" target="_blank">View Ticket in Dashboard</a>
                  </td>
                </tr>
                
                <tr>
                  <td class="text-sm" style="line-height: 1.6; padding-top: 8px;">
                    Please log in to your support dashboard to review and manage this ticket.
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td class="p-6 bg-white border-t border-blue-200">
              <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="footer">
                    <p class="font-size" style="margin-bottom: 1rem;">Regards,<br />The Emirouq Support Team</p>
                    <p style="margin-bottom: 0; font-size: 12px;">© ${new Date().getFullYear()} Emirouq. All rights reserved.</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td>
              <table class="bg-white rounded-lg" role="presentation" width="100%" style="max-width: 600px; margin: 0 auto;" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td style="text-align: right; vertical-align: middle;">
                          <div class="icons-container" style="display: flex; justify-content: flex-end; gap: 1rem;">
...
module.exports = adminSupportTicket;
