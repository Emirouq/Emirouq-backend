...
function calculateLongTradeExecutionAverage(trades) {
...
module.exports = {
  calculateLongTradeExecutionAverage,
  calculateShortTradeExecutionAverage,
};
...
console.log(
  util.inspect(
    calculateLongTradeExecutionAverage(inputTrades),
    false,
    null,
    true /* enable colors */
  )
